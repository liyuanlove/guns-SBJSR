...
Menu.initColumn = function () {
    var columns = [
        ...
        {title: '父编号', field: 'pcode', align: 'center', valign: 'middle', sortable: true},
        ...
        {title: '菜单', field: 'isMenuName', align: 'center', valign: 'middle', sortable: true},
 ...
 * 状态切换
 */
Menu.statusSwitch = function () {
    if (this.check()) {

        var operation = function () {
            var ajax = new $ax(Feng.ctxPath + "/menu/switch", function (data) {
                Feng.success("操作成功!");
                Menu.table.refresh();
            }, function (data) {
